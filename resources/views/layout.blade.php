...
<head>
    ...
    <title>Home | Quick-Shopper</title>
...
.paymentWrap .paymentBtnGroup .paymentMethod .ethod.ex-cash{
	background-image: url("https://mybestwallets.com/wp-content/uploads/2019/07/Depositphotos_242003512_s-2019.jpg");
}
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +88 017 83 2525 24</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> shetu@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="carousel-inner">
						...
						?>
							...
							<div class="item">
								<?php }?>
								<div class="col-sm-4">
									<h1><span>QUICK</span>-SHOPPER</h1>
									<h2>Shop Is Open Now</h2>
									<p>There are some things money can't buy. For everything else, there's a MastarCard. </p>
					...
					<div class="left-sidebar">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								...
								<?php $all_published_manufacture=DB::table('tbl_manufacture')
													->where('publication_status',1)
													->get();
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">QUICK-SHOPPER. 2020. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Shetu</a></span></p>
				</div>
			</div>
		</div>
