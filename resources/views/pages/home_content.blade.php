					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								...
								<li ><a href="#" data-toggle="tab">Children</a></li>
								<li ><a href="#" data-toggle="tab">Furniture</a></li>
								<li ><a href="#" data-toggle="tab">Electronics</a></li>
								<li ><a href="#" data-toggle="tab">Cloths</a></li>
								<li ><a href="#" data-toggle="tab">Sports</a></li>
							</ul>
						</div>
